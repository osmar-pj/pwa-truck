...
import CreateContract from "../crud/create-contract";

export default function ViewContract({ data, fetchData}) {
                  ...
                  <tr key={index}>                    
                    ...
                    <td>
                      <div className="btns">
                        ...
                        <button onClick={() => handleDelete(item.contractId)}>
                          <Delete />
                        </button>
                      </div>
                    </td>
